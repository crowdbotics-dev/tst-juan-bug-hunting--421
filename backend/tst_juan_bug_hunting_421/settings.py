"""
Django settings for tst_juan_bug_hunting_421 project.
...
ROOT_URLCONF = 'tst_juan_bug_hunting_421.urls'
...
WSGI_APPLICATION = 'tst_juan_bug_hunting_421.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_juan_bug_hunting_421 API",
    "DESCRIPTION": "API documentation for tst_juan_bug_hunting_421 App",
    "VERSION": "v1",
}
